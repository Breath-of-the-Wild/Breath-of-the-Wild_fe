          ...
          <div className="px-6 py-4">
            <div className="mb-2">
              ...
              <div className="flex items-center">
                <div className="mr-2 rounded-full bg-blue-600 py-1 px-2 text-xs font-medium text-white">{/* Property Type */}</div>
                <div className="rounded-full bg-yellow-500 py-1 px-2 text-xs font-medium text-white">{/* Property Categories */}</div>
              </div>
            </div>
